...
CMakeFiles/strip_comments:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspace/deal-ii-8.5.1/test/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "strip comments"
	/usr/bin/perl -pi -e 's#^[ \t]*//.*\n##g;' main.cc
...
CMakeFiles/strip_comments.dir/depend:
	cd /workspace/deal-ii-8.5.1/test && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/deal-ii-8.5.1/test /workspace/deal-ii-8.5.1/test /workspace/deal-ii-8.5.1/test /workspace/deal-ii-8.5.1/test /workspace/deal-ii-8.5.1/test/CMakeFiles/strip_comments.dir/DependInfo.cmake --color=$(COLOR)
